...
const VALUES_META = {
    ...
    'transparent': { ico: '\uD83E\uDE9F', name: 'Transparent', color: 'violet' },
    ...
    'open-source': { ico: '\uD83D\uDD13', name: 'Open Source', color: 'sky' },
...
<head>
    ...
    <meta property="og:image" content="https://jobsbyculture.com/api/og?type=compare&amp;a=${slugA}&amp;b=${slugB}">
