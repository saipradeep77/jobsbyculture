...
const CLAIM_CSS = `
        ...
        .claim-banner-text { display: flex; align-items: center; gap: 8px; }
        .claim-banner-text .badge {
        ...
        .claim-banner-text span:last-child {
...
<div class="claim-banner">
    <div class="claim-banner-text">
        ...
        <span>Work at ${escHtml(name)}? <strong>Claim this profile</strong></span>
    </div>
